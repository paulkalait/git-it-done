...
var displayRepos = function(repos, searchTerm){
    ...
    for(var i=0; i <repos.length; i++){
        ...
        repoEl.classList = "list-item flex-row justifu-space-between align-center"
        ...
        //cehck if current repo has issues or not
...
var getUserRepos = function(user){
    ...
    //done after this^ check for any network errors
